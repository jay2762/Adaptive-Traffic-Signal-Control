...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="sumo-rl-main/sumo_rl/nets/2way-single-intersection/single-intersection-gen.rou.xml",
    ...
    write_route_file("sumo-rl-main/sumo_rl/nets/2way-single-intersection/single-intersection-gen.rou.xml", 400000, 100000)
    env = SumoEnvironment(
        net_file="sumo-rl-main/sumo_rl/nets/2way-single-intersection/single-intersection.net.xml",
        single_agent=True,
